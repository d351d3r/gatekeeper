...
class LocalStorageManager private constructor(context: Context) {
    ...
    companion object {
        ...
        /** Пресет изоляции выбран: мастер спрашивает о нем один раз. */
        const val PREF_ISOLATION_PRESET_CHOSEN = "isolation_preset_chosen"

        /** Экран доступов показан один раз сразу после настройки, а не найден поиском. */
        const val PREF_ACCESSES_SHOWN = "accesses_shown"
