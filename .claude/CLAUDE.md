...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-23 (commit 02c3991). Confidence: 100%.
...
### Architecture
**Files:** 120 | **Lines:** 30348 | **Import cycles:** 1
gatekeeper is a kotlin codebase of 120 files. Ranked by PageRank over the import graph: the files most of the codebase ultimately depends on. ---
...
- `app/src/main/java/io/gatekeeper/ui/MainActivity.kt` — 6 commits/90d
- `app/src/main/java/io/gatekeeper/ui/DummyActivity.kt` — 4 commits/90d
- `app/src/main/java/io/gatekeeper/util/Utility.kt` — 6 commits/90d
- `app/src/main/java/io/gatekeeper/ui/SettingsFragment.kt` — 5 commits/90d
- `app/src/main/java/io/gatekeeper/services/FileShuttleService.kt` — 3 commits/90d

### Code health
Three co-equal signals: defect risk 7.45/10 avg, hotspot health 3.97/10 (stable), worst `app/src/main/java/io/gatekeeper/ui/MainActivity.kt` at 1.64/10 · maintainability 8.46/10 · performance risk 4 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
